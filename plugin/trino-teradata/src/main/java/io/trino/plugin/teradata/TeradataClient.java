        ...
        extends BaseJdbcClient
{
            ...
            throws SQLException
    {
        if (!resultSet.isAfterLast()) {
            // Abort connection before closing. Without this, the teradata driver
    ...
    private static class StatisticsDao
    {
        ...
        Map<String, String> getColumnHistograms(JdbcTableHandle table)
        {
            try {
                ...
                //TODO: fix this code error code is random value
                if (e.getCause() instanceof SQLSyntaxErrorException && ((SQLSyntaxErrorException) e.getCause()).getErrorCode() == -1) {
                    // The table is available since teradata 8
    ...
    // See https://dev.teradata.com/doc/refman/8.0/en/optimizer-statistics.html
