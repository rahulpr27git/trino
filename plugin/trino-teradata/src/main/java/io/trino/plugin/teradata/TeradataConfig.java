...
public class TeradataConfig
{
    ...
    // Using `useInformationSchema=true` prevents race condition inside teradata driver's java.sql.DatabaseMetaData.getColumns
    ...
    @Config("teradata.jdbc.use-information-schema")
    @ConfigDescription("Value of useInformationSchema teradata JDBC driver connection property")
    public TeradataConfig setDriverUseInformationSchema(boolean driverUseInformationSchema)
    {
